...
> 제출 전 실제 팀원 이름/역할로 채워주세요 (제출물 필수 항목).

| 이름 | 역할 |
|---|---|
| (이름) | 시스템 통합 / 백엔드 (app.py, 감지 루프) |
| (이름) | 센서 & 하드웨어 (sensors.py, 배선) |
| (이름) | AI 모델 (classifier, 데이터/튜닝) |
| (이름) | 카메라 & 스트리밍 (camera_stream, MediaMTX) |
| (이름) | 웹 대시보드 (templates/static) & 문서 |

---

## 13. 제출물 체크리스트

- [ ] PPT 보고서 ≤ 20p (문제/아키텍처/하드웨어/AI 결과/대시보드 스크린샷/역할)
- [ ] Notion 진행 결과 Report
- [ ] GitHub 업로드 (코드 + 본 README + MediaMTX 설정)
- [ ] 팀원 역할 명시 (§12)
- [ ] 2026-06-16 18:00 제출 / 2026-06-17 데모 준비
